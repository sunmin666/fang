...
class CustController extends Controller
{
	 ...
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/get/cust
	 * @apiVersion 1.0.0
	 ...
	 * @apiGroup GroupName
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/first_contact
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiName cognition
	 * @apiGroup GroupName
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/cognition
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiName family_str
	 * @apiGroup GroupName
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/family_str
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiName work_type
	 * @apiGroup GroupName
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/work_type
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiGroup GroupName
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/intention_area
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiName floor_like
	 * @apiGroup GroupName
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/floor_like
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiGroup GroupName
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/furniture_need
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiName house_num
	 * @apiGroup GroupName
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/house_num
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiName status_id
	 * @apiGroup GroupName
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/status_id
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/store
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiParam (参数) {int} [first_contact] 首次接触方式
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/search
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
...
//		}
	 ...
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/details
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
	 ...
	 * @apiGroup GroupName
	 * @apiParam (参数) {string} cust_id 客户id
	 * @apiSampleRequest http://192.168.1.220/fang/public/api/1.0.0/rocedure
	 * @apiVersion 1.0.0
	 * @apiSuccessExample {json} 成功返回:
	 *     HTTP/1.1 200 OK
	 *     {
