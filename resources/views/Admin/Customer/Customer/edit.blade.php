			...
			<form role="form" action="#" method="post" name="reg_memberinfo" id="reg_memberinfo">
				...
				<div class="form-group">
					...
					<select name="ownership" id="ownership" class="form-control">
						...
						@foreach($ownership as $k => $v)
							<option value="{{$v -> field_id}}" @if($omer -> ownership ==$v-> field_id) selected @endif>{{$v -> name}}</option>
						@endforeach
					</select>
				</div>
				...
				<div class="form-group">
					...
					<select name="purpose" id="purpose" class="form-control">
						...
						@foreach($purpose as $k => $v)
							<option value="{{$v -> field_id}}" @if($omer -> purpose ==$v-> field_id) selected @endif>{{$v -> name}}</option>
						@endforeach
					</select>
				</div>
				...
				<div class="form-group">
					...
					<select name="area" id="area" class="form-control">
						<option value="">--{{ trans('customer.please_choice') }}--</option>
						@foreach($area as $k => $v)
							<option value="{{$v -> field_id}}" @if($omer -> area ==$v-> field_id) selected @endif>{{$v -> name}}</option>
						@endforeach
					</select>
				</div>
				...
				<div class="form-group">
					...
					<select name="residence" id="residence" class="form-control">
						...
						@foreach($residence as $k => $v)
							<option value="{{$v -> field_id}}" @if($omer -> residence ==$v-> field_id) selected @endif>{{$v -> name}}</option>
						@endforeach
					</select>
				</div>
				...
				<div class="form-group">
					...
					<select name="structure" id="structure" class="form-control">
						...
						@foreach($structure as $k => $v)
							<option value="{{$v -> field_id}}" @if($omer -> structure ==$v-> field_id) selected @endif>{{$v -> name}}</option>
						@endforeach
					</select>
				</div>
				...
				<div class="form-group">
					...
					<select name="demand" id="demand" class="form-control">
						...
						@foreach($demand as $k => $v)
							<option value="{{$v -> field_id}}" @if($omer -> demand ==$v-> field_id) selected @endif>{{$v -> name}}</option>
						@endforeach
					</select>
				</div>
				...
				<div class="form-group">
					...
					<select name="apartment" id="apartment" class="form-control">
						...
						@foreach($apartment as $k => $v)
							<option value="{{$v -> field_id}}" @if($omer -> apartment ==$v-> field_id) selected @endif>{{$v -> name}}</option>
						@endforeach
					</select>
				</div>
