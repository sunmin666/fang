...
@section('content')
	...
	<div class="box box-info">
		...
		<form action="{{URL('checkout/38')}}" method="get">
		...
		<div class="box-footer clearfix">
			...
			<div class=" pull-right">{{$checkout -> appends(['name' => $name,'iphone'=> $iphone]) ->links()}}</div>
			<input type="hidden" value="{{$checkout -> count()}}" id="page_count">
		</div>
	</div>
@endsection
@push('include-js')
