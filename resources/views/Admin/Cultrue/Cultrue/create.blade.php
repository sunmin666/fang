               ...
               {{--企业文化分类--}}
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title"
                           placeholder="{{ trans('cultrue.please_title') }}" id="title"
                           maxlength="20">
                </div>
                {{--企业文化图片--}}
...
//            var res = {};
       ...
       $.ajax( {
            ...
            success : function ( data ) {
                //console.log(data);
                if ( data.code == {{config('myconfig.cultrue.cultrue_error_cultrue_code')}}) {
                    layer.msg( data.msg , { time : 2151 } );
                    $( "#store1" ).attr( 'disabled' , false );
                    return false;
                }

                if ( data.code == {{config('myconfig.cultrue.cultrue_success_cultrue_code')}}) {
