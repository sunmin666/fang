...
@section('content')
	...
	<div class="box box-info">
		...
		<div id="status_search">
			<form action="{{URL('listing/52')}}" method="get">
				...
				<input type="text" value="{{$stimes}}" autocomplete="off" name="stime" class="layui-input status" id="test1" style="display: inline-block;">

				<label>{{ trans('sales.etime') }}：</label>
				<input type="text" value="{{$etimes}}" autocomplete="off" name="etime" class="layui-input status" id="test2" style="display: inline-block">
