		...
		<div class="box-body">
			...
			<form role="form" action="#" method="post" name="reg_memberinfo" id="reg_memberinfo">
				...
				<div class="form-group">
					...
					<select name="buildnum" id="buildnum" class="form-control" disabled="disabled">
						<option value="{{$home -> buildnums}}">{{$home -> buildnums}}</option>
					</select>
				</div>
				{{--单元--}}
				<div class="form-group">
					<label>{{ trans('home.unitnum') }}：</label>
					<select name="unitnum" id="unitnum" class="form-control" disabled="disabled">
						<option value="{{$home -> unitnums}}">{{$home -> unitnums}}</option>
					</select>
				</div>
				{{--房号--}}
				<div class="form-group">
					<label>{{ trans('home.roomnum') }}：</label>
					<select name="roomnum" id="roomnum" class="form-control" disabled="disabled">
						<option value="{{$home -> roomnums}}">{{$home -> roomnums}}</option>
					</select>
				</div>
				{{--楼层--}}
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control"
					       onkeyup="if(isNaN(value))execCommand('undo')" value="{{$home -> build_area}}平米"
				...
				<div class="form-group">
					...
					<div class="zzz">
						...
						{{--</button>--}}
						<input type="hidden" value="{{$home -> house_img}}" id="n_img" name="n_img" disabled="disabled">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="house_str" value="{{$home -> house_str}}"
					       placeholder="请输入户型结构" id="house_str" maxlength="12" disabled="disabled">
				</div>
				{{--房子单价--}}
				<div class="form-group">
					...
					<input type="text" class="form-control" name="price"
					       ...
					       placeholder="请输入房子单价" id="price" maxlength="12" disabled="disabled">
				</div>
				{{--折扣--}}
				<div class="form-group">
				...
				<div class="form-group">
					...
					<textarea name="remarks" id="remarks"
					          cols="30" rows="5" class="form-control" placeholder="请输入备注" disabled="disabled">{{$home -> remarks}}</textarea>
				</div>
