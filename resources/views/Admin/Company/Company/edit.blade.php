		...
		<div class="box-body">
			...
			<form role="form" action="#" method="post" name="reg_memberinfo" id="reg_memberinfo">
				<div class="form-group">
					...
					<input type="text" class="form-control" value="{{$company -> comp_cname}}" name="comp_cname" placeholder="{{ trans('company.please_comp_cname') }}" id="comp_cname"
					       maxlength="50">
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" value="{{$company -> comp_ename}}" maxlength="100" placeholder="{{ trans('company.please_comp_ename') }}"
					       name="comp_ename" id="comp_ename">
				</div>
				{{--公司法人代表1--}}
				<div class="form-group">
					<label>{{ trans('company.corporation')}}：</label>
					<input type="text" class="form-control" value="{{$company -> corporation}}" name="corporation" placeholder="{{ trans('company.please_corporation') }}" id="corporation"
					       maxlength="12">
				</div>
				{{--公司身份证号1--}}
				<div class="form-group">
					<label>{{ trans('company.corp_idcard') }}：</label>
					<input type="text" value="{{$company -> corp_idcard}}" oninput = "value=value.replace(/[^\d]/g,'')" class="form-control" name="corp_idcard" placeholder="{{ trans('company.please_corp_idcard') }}" id="corp_idcard"
					       maxlength="18">
				</div>
				{{--法人手机号1--}}
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" value="{{$company -> credit_code}}" class="form-control" name="credit_code" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" placeholder="{{ trans('company.please_credit_code') }}" id="credit_code"
					       maxlength="18">
				</div>
				{{--注册地址1--}}
				<div class="form-group">
					<label>{{ trans('company.address') }}：</label>
					<input type="text" value="{{$company -> address}}" class="form-control" name="address" placeholder="{{ trans('company.please_address') }}" id="address" maxlength="100">
				</div>
				{{--公司电话座机1--}}
				<div class="form-group">
					<label>{{ trans('company.telphone') }}：</label>
					<input type="text" value="{{$company -> telphone}}" class="form-control" name="telphone" placeholder="{{ trans('company.please_telphone') }}" id="telphone" maxlength="12">
				</div>
				{{--公司/企业类型1--}}
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" value="{{$company -> scope}}" class="form-control" name="scope" placeholder="{{ trans('company.please_scope') }}" id="scope" maxlength="100">
				</div>
				{{--注册资本1--}}
				<div class="form-group">
					<label>{{ trans('company.reg_capital') }}：</label>
					<input type="text" value="{{$company -> reg_capital}}" class="form-control" onkeyup="value=value.replace(/[^\d.]/g,'')" name="reg_capital" placeholder="{{ trans('company.please_reg_capital') }}" id="reg_capital"
					       maxlength="20">
				</div>
				{{--使用iHOUSER联系人1--}}
				<div class="form-group">
					<label>{{ trans('company.contacts') }}：</label>
					<input type="text" value="{{$company -> contacts}}" class="form-control" name="contacts" placeholder="{{ trans('company.please_contacts') }}" id="contacts"
					       maxlength="12">
				</div>
				{{--使用iHOUSER系统联系人手机号1--}}
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" oninput = "value=value.replace(/[^\d]/g,'')" class="form-control" name="cont_idcard" placeholder="{{ trans('company.please_cont_idcard') }}" id="cont_idcard"
					       maxlength="18" value="{{$company -> cont_idcard}}">
				</div>
				{{--公司成立日期1--}}
				<div class="form-group">
					<label>{{ trans('company.created_date') }}：</label>
					<input type="text" value="{{date('Y-m-d',$company -> created_date) }}" class="layui-input" autocomplete="off" id="created_date" placeholder="{{ trans('company.please_created_date') }}">
				</div>
				{{--公司营业期限开始1--}}
				<div class="form-group">
					<label>{{ trans('company.business_date') }}：</label>
					<input type="text" value="{{date('Y-m-d',$company -> business_date) }}" class="layui-input" autocomplete="off" id="business_date" placeholder="{{ trans('company.please_business_date') }}">

				</div>
				{{--公司营业期限结束--}}
				<div class="form-group">
					<label>{{ trans('company.expire_date') }}：</label>
					<input type="text" class="layui-input" value="{{date('Y-m-d',$company -> expire_date) }}" autocomplete="off" id="expire_date" placeholder="{{ trans('company.please_expire_date') }}">
				</div>
