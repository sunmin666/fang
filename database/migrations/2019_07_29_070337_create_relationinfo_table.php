...
class CreateRelationinfoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('relationinfo', function (Blueprint $table) {
			...
			DB::statement( "ALTER TABLE `relationinfo` comment '公司内部关系表'" );
    }
    ...
    {
        Schema::dropIfExists('relationinfo');
    }
}
